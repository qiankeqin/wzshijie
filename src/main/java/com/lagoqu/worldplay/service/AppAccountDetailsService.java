...
/**描述：账户明细<br>
 * 作者：王小欢 <br>
 * 修改日期：2015年10月28日下午3:42:34 <br>
 * E-mail:  <br> 
 */
@Service
public class AppAccountDetailsService extends BaseDao<AccountDetails>{
	 ...
	 * 描述：查询个人账户明细
	 * 作者: 王小欢
	 * 修改日期：2015年10月28日上午9:48:04
	 * @param page
	 * @param size
	 * @param membersID
	 * @return
	 */
	public Pagination<JSONArray> myAccountDetails(int page,int size,int membersID){
