...
//		}
		...
		// imgmsg.put("type","img");
		// imgmsg.put("url",
		// HTTPClientUtils.getURL(Constants.APPKEY.replace("#", "/") +
	...
	public static void sendCMDtoUser(String userId,String action,Map<String,String> parms){
		String from = "admin";
		//消息类型 
		String targetTypeus = "users";
		//组消息内容
